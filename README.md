...
<details>
<summary>💬 Random dev quote (click to refresh — reload the page for a new one)</summary>
<br/>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/expo-1C1E24?style=for-the-badge&logo=expo&logoColor=%23D04A37"/>
...
<!--
  ...
  Setup (one-time):
  1. In this repo, add .github/workflows/snake.yml using the Platane/snk action.
  2. It runs on a schedule and pushes the animated SVG below to an `output` branch.
...
```text
🔭 Currently building   : React Native + ML powered mobile tools
